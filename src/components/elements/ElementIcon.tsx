...
const PATHS: Record<IconName, string> = {
  ...
  "map-pin": "M12 21s7-6.3 7-11a7 7 0 10-14 0c0 4.7 7 11 7 11zm0-8.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z",
  clock: "M12 21a9 9 0 100-18 9 9 0 000 18zm0-14v5l3.5 2",
  truck: "M3 7h11v9H3zM14 10h4l3 3v3h-7zM7 19a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm10 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z",
  ...
  facebook:
    "M14 8h3V4h-3a5 5 0 00-5 5v2H6v4h3v7h4v-7h3l1-4h-4V9a1 1 0 011-1z",
  instagram:
